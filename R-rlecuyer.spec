...
Version  : 0.3.8
Release  : 15
URL      : https://cran.r-project.org/src/contrib/rlecuyer_0.3-8.tar.gz
Source0  : https://cran.r-project.org/src/contrib/rlecuyer_0.3-8.tar.gz
...
%setup -q -n rlecuyer
pushd ..
cp -a rlecuyer buildavx2
popd
pushd ..
cp -a rlecuyer buildavx512
popd
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1737156449
...
%files lib
%defattr(-,root,root,-)
/V3/usr/lib64/R/library/rlecuyer/libs/rlecuyer.so
/V4/usr/lib64/R/library/rlecuyer/libs/rlecuyer.so
